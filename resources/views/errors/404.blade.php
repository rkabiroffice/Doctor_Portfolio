...
<body class="font-sans antialiased bg-slate-50 min-h-screen flex items-center justify-center px-6">
    <div class="max-w-xl text-center bg-white rounded-3xl shadow-sm border border-slate-100 p-10">
        <p class="text-xs font-medium text-slate-400 uppercase tracking-wider">404 Error</p>
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight mt-3">The page you are looking for could not be found.</h1>
        <p class="text-sm text-slate-600 mt-4">It may have been moved, renamed, or is temporarily unavailable.</p>
